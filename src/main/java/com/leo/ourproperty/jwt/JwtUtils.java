...
public class JwtUtils {
    ...
    public static final String JWT_SECRETKEY = "0123456789-0123456789-0123456789";
    ...
    private static Key generateKey(){
        return Keys.hmacShaKeyFor(JWT_SECRETKEY.getBytes(StandardCharsets.UTF_8));
    }
    ...
    public static JwtToken createToken(String username, String role) {
        ...
        String token = Jwts.builder()
                ...
                //metodo para definir o perfil do user
                .claim("role", role)
                .compact();
